class ProductRunner{
	public static void main(String Item[]){
		...
		float grocery1[]={Sugar,Toor_dal,Green_gram,Urad_dal,Channa_dal,Tamarld,Garlic_Large,Gold_Winner,
		...
		Chairs,Cloths,carpet,Glasses,Lamp,Towel,Ribbon,Juice,Ketchup,Split_gram_lentil,Pepper,Cumin,Vendhayam,Tamarind,Chilly,Turmeric_Powder,
		Sombu,Handling_charges,Gunny_Bag};
		...
		System.out.println("Price of Handling_charges:"+grocery1[8]);
		System.out.println("Price of Gunny_Bag:"+grocery1[9]);
